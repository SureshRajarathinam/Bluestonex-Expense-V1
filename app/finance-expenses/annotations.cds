...
annotate FinanceService.FinanceClaims with @(
  ...
  UI.LineItem: [
    ...
    { $Type: 'UI.DataField', Value: payrollArea,      Label: 'Payroll Area',   ![@UI.Importance]: #Medium },
    ...
    { $Type: 'UI.DataField', Value: managerApprovedAt, Label: 'Mgr Approved On',![@UI.Importance]: #Low   },
    {
  ...
  UI.Identification: [
    { $Type: 'UI.DataFieldForAction', Action: 'FinanceService.financeApprove', Label: 'Finance Approve', ![@UI.Importance]: #High },
    { $Type: 'UI.DataFieldForAction', Action: 'FinanceService.settleClaim',    Label: 'Settle',          ![@UI.Importance]: #High },
    { $Type: 'UI.DataFieldForAction', Action: 'FinanceService.rejectClaim',    Label: 'Reject',          ![@UI.Importance]: #Medium }
  ],
