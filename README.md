...
*Living documentation. Backend logic and all flows are covered by `npm test` (**151 pass**, 1 skip, 1 todo). Fiori UI rendering should be verified in a browser against `cds watch`.*
